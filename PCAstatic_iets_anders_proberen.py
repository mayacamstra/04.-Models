...
Y_train_std = filtered_df_std.loc[:, :DATE_TRAIN_END]  # Data until 2019-12
Y_validate_std = filtered_df_std.loc[:, DATE_VALIDATE_START:DATE_VALIDATE_END]  # Data from 2020-01 to 2023-11
...
for num_factors in factor_range:
    ...
    # Zorg ervoor dat current_index een pandas PeriodIndex is
    current_index = pd.PeriodIndex(Y_train_std.columns, freq='M')

    # Voorspellingen voor tijdstappen t+1 tot t+4
    for t in range(1, 3):
