...
results_df.to_excel('results_PLSstatic_with_AIC_BIC_LogLikelihood.xlsx', index=False)

print("Results saved to results_PLSstatic_with_AIC_BIC_LogLikelihood.xlsx")
