...
results_df.to_excel('results_PCAcombined_with_AIC_BIC_LogLikelihood_Residuals.xlsx', index=False)

print("Results saved to results_PCAcombined_with_AIC_BIC_LogLikelihood_Residuals.xlsx")
