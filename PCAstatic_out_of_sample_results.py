...
predicted_df = pd.read_excel("C:/Thesis/04. Models/predicted_variables_matrix_12.xlsx")
...
# results_df.to_excel('PCAstatic_out_of_sample_metrics_factor_5.xlsx', index=False)
