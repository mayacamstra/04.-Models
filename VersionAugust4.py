...
FILE_PATH = r"C:\Users\mayac\OneDrive - ORTEC Finance\Thesis\03. Data\Final version data\Static.xlsx"
...
Y_train_PCA = df_data.loc[:(DATE_VALIDATE-relativedelta(months=1)),:]

# Prepare data for individual model training
REGRESSION_STEP = 12
Y_train_other = Y_train_PCA.iloc[REGRESSION_STEP:,:]
Y_reg_train = df_data.loc[:(DATE_VALIDATE-relativedelta(months=REGRESSION_STEP+1)),:]
