...
predicted_df = pd.read_excel("C:/Thesis/04. Models/PLScombined_predicted_variables_matrix_12.xlsx")
...
results_df.to_excel('PLScombined_out_of_sample_metrics_factor_12.xlsx', index=False)
